...
prices = LOAD '/BDAT1002/pig/stocks' USING PigStorage(',') as (exchange:chararray, symbol:chararray, date:datetime, open:float, high:float, low:float, close:float,volume:int, adj_close:float);
...
STORE top10 INTO '/BDAT1002/pig/avg-volume' USING PigStorage(',');